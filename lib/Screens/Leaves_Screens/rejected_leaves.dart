...
class RejectedLeaves extends StatefulWidget {
  const RejectedLeaves({super.key});
...
class _RejectedLeavesState extends State<RejectedLeaves> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Rejected Leaves', style: TextStyle(color: Colors.white, fontSize: 20)),
        titleSpacing: 0,
        leading: IconButton(
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: Text(
                        request['status']!,
                        style: TextStyle(
                          color: request['status'] == 'Rejected' ? Colors.red : Colors.white,
                        ),
                      ),
                    ),
                  );
